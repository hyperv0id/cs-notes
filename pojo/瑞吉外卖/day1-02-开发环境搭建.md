...
使用IDEA的spring initializer构建项目，使用阿里的源，添加一下配置

![image-20220815210128563](https://pic-1257412153.cos.ap-nanjing.myqcloud.com/images/2022/08/15/image-20220815210128563-f3b9d7.png)
    ...
    <build>
        <plugins>
            ...
            <plugin>
                ...
                <configuration>
                    <mainClass>com.example.reggie.ReggieApplication</mainClass>
                </configuration>
                <executions>
                    <execution>
                        <id>repackage</id>
...
在resources目录下添加资料中的文件，包括项目配置、前后端资源

- 将application.yml 放到根目录
- 将backend和front文件夹放到static目录下，按视频做需要配置路径

![image-20220815214028496](https://pic-1257412153.cos.ap-nanjing.myqcloud.com/images/2022/08/15/image-20220815214028496-8b6ca2.png)
...
![image-20220815213149578](https://pic-1257412153.cos.ap-nanjing.myqcloud.com/images/2022/08/15/image-20220815213149578-bf1e77.png)
